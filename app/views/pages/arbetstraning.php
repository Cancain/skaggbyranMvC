...
<div class="wrapper">
      ...
      <section class="content-container">
        <header class="content">
          <h1>Arbetsträning</h1>
          <p>
          Vi är ett arbetsintegrerande socialt företag för den som behöver arbetsträning 
inom IT och Medieproduktion.
          </p>
          <p>På Skäggbyrån arbetar vi med hemsidor, layout, illustrationer, foto och film. 
...
<?php endif; ?>
        ...
        <div class="contentBox contentBoxA">
          <p>Arbetsträningen måste vara beviljad av Arbetsförmedlingen innan den påbörjas. Skäggbyrån utser sedan en handledare som ska
